       ...
       <div className={activeIntelView || isProfileVisible ? 'blur-sm pointer-events-none' : ''}>
          <header className="glass rounded-2xl flex items-center justify-between mb-8 px-6 py-4">
            ...
            <div className="hidden lg:flex items-center gap-2 glass rounded-lg p-1">
              ...
              <NavButton view="devices" label={t('navDevices')} icon={<svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>} />
          ...
          <footer className="fixed bottom-0 left-0 right-0 lg:hidden p-2 glass border-t border-white/10 z-50">
            <div className="flex items-center justify-around">
               ...
               <NavButton view="devices" label={t('navDevices')} icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>} />
